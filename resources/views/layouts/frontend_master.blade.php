...
<head>
	...
	<link href="{{ asset('frontend_assets') }}/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="{{ asset('frontend_assets') }}/css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="{{ asset('frontend_assets') }}/images/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
            ...
            <div class="scroll">
                <div class="row">
                    <div class="col-lg-3 col-sm-2 col-3 left-mar">
                        <img src="{{ asset('frontend_assets') }}/images/k1.jpg" alt="" class="img-fluid">
                    </div>
                ...
                <div class="row my-4">
                    <div class="col-lg-3 col-sm-2 col-3 left-mar">
                        <img src="{{ asset('frontend_assets') }}/images/k2.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-2 col-3 left-mar">
                        <img src="{{ asset('frontend_assets') }}/images/k3.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
...
<div class="join-agile text-left p-4">
    <div class="row">
        ...
        <div class="col-sm-5 offerimg-w3l">
            <img src="{{ asset('frontend_assets') }}/images/off1.png" alt="" class="img-fluid">
        </div>
    </div>
</div>
</div>
...
<div class="join-agile text-left p-4">
    <div class="row ">
        ...
        <div class="col-sm-5 offerimg-w3l">
            <img src="{{ asset('frontend_assets') }}/images/off2.png" alt="" class="img-fluid">
        </div>
    </div>
</div>
</div>
...
<ul>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay2.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay5.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay1.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay4.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay6.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay3.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay7.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay8.png" alt="">
    </li>
    <li>
        <img src="{{ asset('frontend_assets') }}/images/pay9.png" alt="">
    </li>
</ul>
</div>
<!-- //payment -->
...
<!-- scroll seller -->
<script src="{{ asset('frontend_assets') }}/js/scroll.js"></script>
<!-- //scroll seller -->
