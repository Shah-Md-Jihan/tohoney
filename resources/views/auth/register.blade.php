    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-md-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white">
        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Enter your username">
        ...
        <div class="mg-t-40 tx-center">Already have an account? 
            @if (Route::has('login'))
                <a class="tx-info" href="{{ route('login') }}" style="text-decoration: none; font-weight: 600">Sign In</a>
            @endif
        </div>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
